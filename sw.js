...
const CACHE_NAME = 'moneynyang-v1-cache-v123';
...
const LOCAL_RESOURCES = [
  ...
  './index.html',
  './manifest.json',
  './css/main.css?v=20260629c',
  './css/mobile.css?v=20260629c',
  './img/icons/app-icon-192.png',
  './img/icons/app-icon-512.png',
  './js/sw-init.js',
  './js/storage.js?v=20260628',
  './js/leave.js?v=20260629f',
  './js/ui.js?v=20260629d',
  './js/salary.js?v=20260629e',
  './js/budget.js?v=20260629d',
  './js/data-utils.js',
  './js/nyang-emoji.js',
  './js/assistant.js?v=20260627',
  './js/freelance.js?v=20260627',
  './js/render-salary.js?v=20260627',
  './js/jobtype.js?v=20260629c',
  './js/calendar-modes.js?v=20260629f',
  './js/notifications.js?v=20260628a',
  './js/init.js?v=20260629f',
  './js/tutorial.js',
];
